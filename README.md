<div align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.5.3-blue.svg" alt="Version">
...
> **Production:** Pin versions with `LOGTIDE_BACKEND_IMAGE=logtide/backend:0.5.3` in your `.env` file.
